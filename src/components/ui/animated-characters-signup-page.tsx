...
import { Eye, EyeOff, Mail, User, Shield, GraduationCap, Sparkles, BookOpen } from "lucide-react";
          ...
          {step === 1 && (
            <>
              <div className="text-center mb-10">
                ...
                <p className="text-slate-400 text-sm">Join SikshaStack to start your journey</p>
              </div>
